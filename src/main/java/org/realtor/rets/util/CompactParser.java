/* $Header: c:\CVSROOT2/rets/commons/src/main/java/org/realtor/rets/util/CompactParser.java,v 1.2 2003/12/04 15:27:03 rsegelman Exp $  */
...
public class CompactParser {
    ...
    /**
     *  Returns a Vector containing the names of the columns.
     * @return The names of the columns.
     */
    public Vector<Set<String>> getColumns() {
        Vector<Set<String>> rv = new Vector<Set<String>>();
