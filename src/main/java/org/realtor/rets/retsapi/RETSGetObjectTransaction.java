...
public class RETSGetObjectTransaction extends RETSTransaction
{
	 ...
	 * 
	 */
	private static final long serialVersionUID = -6379189939243792499L;
     ...
     * of object requested (e.g., <code>"Photo"</code>; see {@link #setType(String)} ),
...
//    protected Collection fBodyParts;
    ...
    private String imageAccept = "image/jpeg"; // default
    ...
    /**
     * Sets the objectdata attribute to the string passed in. 1.8
     *
     * @param str objectdata attribute value
     */
    public void setObjectData(String str) {
        cat.debug("set ObjectData=" + str);
        setRequestVariable("ObjectData", str);
    }
...
//            multipartResponse.writeTo(System.err);
            ...
            if ( parts == null ) parts = new ArrayList<BodyPart>();
        }
    }
...
//            String headerContent = (String) getResponseHeaderMap().get(headerName);
        ...
        parts = new ArrayList<BodyPart>(1); // We may not have *any*, but we won't have more than 1.
        try {
     ...
     */
    public Collection<BodyPart> allReturnedObjects() {
        return parts;
    }
    ...
    public InputStream getPartAsStream(int objectIndex) {
        ...
        try {
            ...
            e.printStackTrace();
            throw new RuntimeException("Error in getPartAsStream()",e);
        }
        return inputStream;
    }
